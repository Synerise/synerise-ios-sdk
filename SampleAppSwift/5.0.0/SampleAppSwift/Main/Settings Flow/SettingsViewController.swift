...
class SettingsViewController: DefaultViewController {
    ...
    @IBOutlet weak var inAppMessagingCheckGlobalControlGroupsOnDefinitionsFetchSwitch: UISwitch!
    ...
    @IBAction func inAppMessagingCheckGlobalControlGroupsOnDefinitionsFetchTapped() {
        Synerise.settings.inAppMessaging.checkGlobalControlGroupsOnDefinitionsFetch = self.inAppMessagingCheckGlobalControlGroupsOnDefinitionsFetchSwitch.isOn
        settingsService.set(self.inAppMessagingCheckGlobalControlGroupsOnDefinitionsFetchSwitch.isOn, forKey: .checkGlobalControlGroupsOnDefinitionsFetchKey)
    }
    ...
    func loadSettings() {
        ...
        self.inAppMessagingCheckGlobalControlGroupsOnDefinitionsFetchSwitch.isOn = Synerise.settings.inAppMessaging.checkGlobalControlGroupsOnDefinitionsFetch
