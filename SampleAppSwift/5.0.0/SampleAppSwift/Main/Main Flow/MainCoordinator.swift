...
class MainCoordinator: Coordinator {
    ...
    func showDebugFeaturesMenu() {
        let debugFeaturesViewController: DebugFeaturesViewController = makeDebugFeaturesViewController()
    
        debugFeaturesViewController.onCloseButton = {
            debugFeaturesViewController.dismiss(animated: true, completion: {
                
            })
        }
        
        let navigationController = UINavigationController(rootViewController: debugFeaturesViewController)
        navigationController.providesPresentationContextTransitionStyle = true
        navigationController.definesPresentationContext = true
        navigationController.modalPresentationStyle = UIModalPresentationStyle.overCurrentContext
        navigationController.title = "VIEW_CONTROLLER_DEBUG_FEATURES_TITLE".localized()
        
        configure.router.present(navigationController, animated: true, completion: nil)
    }
    ...
    private func makeDebugFeaturesViewController() -> DebugFeaturesViewController {
        let storyboard: UIStoryboard = Storyboards.getDebugFeatures()
        guard let viewController = StoryboardUtils.instantiateViewController("DebugFeaturesViewControllerIdentifier", storyboard: storyboard) as? DebugFeaturesViewController else {
            fatalError()
        }
...
extension MainCoordinator: DebugFeaturesViewControllerDelegate {
    func resetApplicationWasPressed(_ debugFeaturesMenuViewController: DebugFeaturesViewController) {
