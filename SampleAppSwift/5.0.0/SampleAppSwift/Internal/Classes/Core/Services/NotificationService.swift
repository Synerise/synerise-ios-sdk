...
class NotificationService: BaseService {
    ...
    private func setCategories() {
        ...
        let carouselPreviousAction = UNNotificationAction(identifier: SNRCarouselContentExtensionViewControllerPreviousItemIdentifier, title: "Previous", options: [])
        let carouselGoAction = UNNotificationAction(identifier: SNRCarouselContentExtensionViewControllerChooseItemIdentifier, title: "Go", options: [])
        let carouselNextAction = UNNotificationAction(identifier: SNRCarouselContentExtensionViewControllerNextItemIdentifier, title: "Next", options: [])
            
        let carouselCategory = UNNotificationCategory(identifier: SNRCarouselContentExtensionViewControllerCategoryIdentifier, actions: [carouselPreviousAction, carouselGoAction, carouselNextAction], intentIdentifiers: [], options: [])

        var categories = Set<UNNotificationCategory>()
        categories.insert(singleMediaCategory)
        categories.insert(carouselCategory)
        
        Synerise.setNotificationCategories(categories)
    }
