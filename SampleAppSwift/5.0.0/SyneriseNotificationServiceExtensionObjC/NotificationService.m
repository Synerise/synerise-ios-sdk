...
- (void)didReceiveNotificationRequest:(UNNotificationRequest *)request withContentHandler:(void (^)(UNNotificationContent * _Nonnull))contentHandler {
    ...
    [SNRNotificationServiceExtension didReceiveNotificationExtensionRequest:request withMutableNotificationContent:self.bestAttemptContent options:@{
        kSNRNotificationServiceExtensionOptionsPushDismissProcessing: @(YES)
    }];
    ...
    //self.bestAttemptContent.title = [@"[Modified] " stringByAppendingString:self.bestAttemptContent.title];
