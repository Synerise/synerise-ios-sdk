...
@property (nonatomic, readonly, copy) NSArray<SNRPromotionVoucherData *> * _Nullable vouchers;
...
enum SNRVoucherCodeStatus : NSInteger;

/// <code>PromotionVoucherData</code> class
SWIFT_CLASS_NAMED("PromotionVoucherData")
@interface SNRPromotionVoucherData : SNRBaseModel
@property (nonatomic, readonly, copy) NSString * _Nonnull code;
@property (nonatomic, readonly) enum SNRVoucherCodeStatus status;
@property (nonatomic, readonly) BOOL autoGenerated;
@property (nonatomic, readonly, copy) NSDate * _Nullable lastingAt;
@property (nonatomic, readonly, copy) NSDate * _Nullable redeemedAt;
@property (nonatomic, readonly, copy) NSDate * _Nonnull assignedAt;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic) BOOL includeVouchers;
